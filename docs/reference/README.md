...
| `metadata_architecture.md` | Canonical metadata families, shared/provider/language adapter ownership, presentation boundary and current language-policy maturity. |
