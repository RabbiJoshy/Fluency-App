...
const CACHE_NAME = 'flashcards-v564';
...
const ASSET_VERSION = '20260926v20';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260926v20',
  '/css/light-theme.css?v=20260926v20',
  '/config/config.json',
  ...
  '/js/reverse-cues.js?v=20260926v20',
  '/js/card-metadata-pills.js?v=20260925cues',
  '/js/flashcards.js?v=20260926v20',
  '/icons/tatoeba.svg',
