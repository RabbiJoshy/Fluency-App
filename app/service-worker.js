...
const CACHE_NAME = 'flashcards-v448';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260917i',
  '/css/light-theme.css?v=20260917i',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260917i',
  ...
  '/js/about-example.js?v=20260917i',
  ...
  '/js/flashcards.js?v=20260917i',
  `/js/example-personalisation.js?v=${ASSET_VERSION}`,
  '/js/flashcards-modals.js?v=20260917i',
