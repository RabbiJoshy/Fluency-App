...
const CACHE_NAME = 'flashcards-v446';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260917g',
  '/css/light-theme.css?v=20260917g',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260917g',
  ...
  '/js/about-example.js?v=20260917g',
  ...
  '/js/flashcards.js?v=20260917g',
  `/js/example-personalisation.js?v=${ASSET_VERSION}`,
  '/js/flashcards-modals.js?v=20260917e',
