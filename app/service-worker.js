...
const CACHE_NAME = 'flashcards-v436';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260916m',
  '/css/light-theme.css?v=20260916m',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260916q',
  ...
  '/js/about-example.js?v=20260916q',
  ...
  '/js/ui.js?v=20260916r',
  '/js/vocab.js?v=20260916s',
  ...
  '/js/reverse-cues.js?v=20260916q',
  '/js/card-metadata-pills.js?v=20260916l',
  '/js/flashcards.js?v=20260916s',
  `/js/example-personalisation.js?v=${ASSET_VERSION}`,
  '/js/flashcards-modals.js?v=20260916s',
