...
const CACHE_NAME = 'flashcards-v530';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260921spot',
  '/css/light-theme.css?v=20260921spot',
  '/config/config.json',
  ...
  '/js/ui.js?v=20260921x',
  '/js/fast-track-preferences.js?v=20260920a',
  '/js/vocab.js?v=20260921gc',
  ...
  '/js/flashcards.js?v=20260921spot',
  '/icons/tatoeba.svg',
