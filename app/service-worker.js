...
const CACHE_NAME = 'flashcards-v560';
...
const ASSET_VERSION = '20260926carddata';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260926carddata',
  '/css/light-theme.css?v=20260926carddata',
  '/config/config.json',
  ...
  '/js/reverse-cues.js?v=20260925cues',
  '/js/card-metadata-pills.js?v=20260925cues',
  '/js/flashcards.js?v=20260925cues',
  '/icons/tatoeba.svg',
