...
const CACHE_NAME = 'flashcards-v375';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260913e',
  '/css/light-theme.css?v=20260828a',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260913e',
  ...
  '/js/about-example.js?v=20260913e',
