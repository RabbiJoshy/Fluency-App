...
const CACHE_NAME = 'flashcards-v483';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260919m',
  '/css/light-theme.css?v=20260919i',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260919m',
