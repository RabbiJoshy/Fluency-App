...
const CACHE_NAME = 'flashcards-v462';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260918h',
  '/css/light-theme.css?v=20260917k',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260918h',
