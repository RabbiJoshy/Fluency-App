...
const CACHE_NAME = 'flashcards-v484';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260919n',
  '/css/light-theme.css?v=20260919j',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260919n',
