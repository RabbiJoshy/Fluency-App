...
const CACHE_NAME = 'flashcards-v488';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260920b',
  '/css/light-theme.css?v=20260919k',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260920b',
