...
const CACHE_NAME = 'flashcards-v442';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260917c',
  '/css/light-theme.css?v=20260917c',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260917c',
  ...
  '/js/about-example.js?v=20260917c',
