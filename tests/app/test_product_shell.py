...
EXPECTED_CACHE_NAME = "flashcards-v487"
...
class ProductShellTests(unittest.TestCase):
    ...
    def test_spotify_login_uses_deployable_public_configuration(self) -> None:
        ...
        self.assertIn("/js/main.js?v=20260920a", worker)
        self.assertIn("/js/ui.js?v=20260920a", worker)
    ...
    def test_spotify_playlist_import_looks_up_lyrics_with_visible_percent(self) -> None:
        ...
        self.assertIn('css/style.css?v=20260920a', html)
